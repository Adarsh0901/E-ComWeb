...
export const register = (name, email, phoneNumber, gender, password) => async (dispatch) => {
    try {
        dispatch({
        ...
        const {data} = await axios.post('/api/users', {name,email,phoneNumber,gender,password}, config)
